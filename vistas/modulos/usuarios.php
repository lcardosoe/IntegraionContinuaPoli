            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control input-lg" name="nuevoCorreo" placeholder="Ingrese correo" id="nuevoCorreo" required>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control input-lg" name="editarCorreo" placeholder="Ingrese correo" id="editarCorreo" required>
            ...
            <!-- ENTRADA PARA LA CONTRASEÑA -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="password" class="form-control input-lg" name="editarPassword" placeholder="Ingrese su nueva contraseña">
